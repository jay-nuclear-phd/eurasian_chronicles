(function(){const h=document.createElement("link").relList;if(h&&h.supports&&h.supports("modulepreload"))return;for(const c of document.querySelectorAll('link[rel="modulepreload"]'))r(c);new MutationObserver(c=>{for(const m of c)if(m.type==="childList")for(const f of m.addedNodes)f.tagName==="LINK"&&f.rel==="modulepreload"&&r(f)}).observe(document,{childList:!0,subtree:!0});function u(c){const m={};return c.integrity&&(m.integrity=c.integrity),c.referrerPolicy&&(m.referrerPolicy=c.referrerPolicy),c.crossOrigin==="use-credentials"?m.credentials="include":c.crossOrigin==="anonymous"?m.credentials="omit":m.credentials="same-origin",m}function r(c){if(c.ep)return;c.ep=!0;const m=u(c);fetch(c.href,m)}})();function wf(i){return i&&i.__esModule&&Object.prototype.hasOwnProperty.call(i,"default")?i.default:i}var Cr={exports:{}},Nn={};/**
 * @license React
 ...
 *
 * @license MIT
 */var df="popstate";function Ip(i={}){function h(c,m){let{pathname:f="/",search:S="",hash:w=""}=$a(c.location.hash.substring(1));return!f.startsWith("/")&&!f.startsWith(".")&&(f="/"+f),Hr("",{pathname:f,search:S,hash:w},m.state&&m.state.usr||null,m.state&&m.state.key||"default")}function u(c,m){let f=c.document.querySelector("base"),S="";if(f&&f.getAttribute("href")){let w=c.location.href,p=w.indexOf("#");S=p===-1?w:w.slice(0,p)}return S+"#"+(typeof m=="string"?m:Un(m))}function r(c,m){Ct(c.pathname.charAt(0)==="/",`relative pathnames are not supported in hash history.push(${JSON.stringify(m)})`)}return Ep(h,u,r,i)}function Ie(i,h){if(i===!1||i===null||typeof i>"u")throw new Error(h)}function Ct(i,h){if(!i){typeof console<"u"&&console.warn(h);try{throw new Error(h)}catch{}}}function Ap(){return Math.random().toString(36).substring(2,10)}function hf(i,h){return{usr:i.state,key:i.key,idx:h}}function Hr(i,h,u=null,r){return{pathname:typeof i=="string"?i:i.pathname,search:"",hash:"",...typeof h=="string"?$a(h):h,state:u,key:h&&h.key||r||Ap()}}function Un({pathname:i="/",search:h="",hash:u=""}){return h&&h!=="?"&&(i+=h.charAt(0)==="?"?h:"?"+h),u&&u!=="#"&&(i+=u.charAt(0)==="#"?u:"#"+u),i}function $a(i){let h={};if(i){let u=i.indexOf("#");u>=0&&(h.hash=i.substring(u),i=i.substring(0,u));let r=i.indexOf("?");r>=0&&(h.search=i.substring(r),i=i.substring(0,r)),i&&(h.pathname=i)}return h}function Ep(i,h,u,r={}){let{window:c=document.defaultView,v5Compat:m=!1}=r,f=c.history,S="POP",w=null,p=M();p==null&&(p=0,f.replaceState({...f.state,idx:p},""));function M(){return(f.state||{idx:null}).idx}function I(){S="POP";let L=M(),V=L==null?null:L-p;p=L,w&&w({action:S,location:B.location,delta:V})}function D(L,V){S="PUSH";let J=Hr(B.location,L,V);u&&u(J,L),p=M()+1;let H=hf(J,p),Q=B.createHref(J);try{f.pushState(H,"",Q)}catch(oe){if(oe instanceof DOMException&&oe.name==="DataCloneError")throw oe;c.location.assign(Q)}m&&w&&w({action:S,location:B.location,delta:1})}function U(L,V){S="REPLACE";let J=Hr(B.location,L,V);u&&u(J,L),p=M();let H=hf(J,p),Q=B.createHref(J);f.replaceState(H,"",Q),m&&w&&w({action:S,location:B.location,delta:0})}function q(L){return Mp(L)}let B={get action(){return S},get location(){return i(c,f)},listen(L){if(w)throw new Error("A history only accepts one active listener");return c.addEventListener(df,I),w=L,()=>{c.removeEventListener(df,I),w=null}},createHref(L){return h(c,L)},createURL:q,encodeLocation(L){let V=q(L);return{pathname:V.pathname,search:V.search,hash:V.hash}},push:D,replace:U,go(L){return f.go(L)}};return B}function Mp(i,h=!1){let u="http://localhost";typeof window<"u"&&(u=window.location.origin!=="null"?window.location.origin:window.location.href),Ie(u,"No window.location.(origin|href) available to create URL");let r=typeof i=="string"?i:Un(i);return r=r.replace(/ $/,"%20"),!h&&r.startsWith("//")&&(r=u+r),new URL(r,u)}function xf(i,h,u="/"){return zp(i,h,u,!1)}function zp(i,h,u,r){let c=typeof h=="string"?$a(h):h,m=na(c.pathname||"/",u);if(m==null)return null;let f=vf(i);Cp(f);let S=null;for(let w=0;S==null&&w<f.length;++w){let p=Lp(m);S=_p(f[w],p,r)}return S}function vf(i,h=[],u=[],r="",c=!1){let m=(f,S,w=c,p)=>{let M={relativePath:p===void 0?f.path||"":p,caseSensitive:f.caseSensitive===!0,childrenIndex:S,route:f};if(M.relativePath.startsWith("/")){if(!M.relativePath.startsWith(r)&&w)return;Ie(M.relativePath.startsWith(r),`Absolute route path "${M.relativePath}" nested under path "${r}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),M.relativePath=M.relativePath.slice(r.length)}let I=sa([r,M.relativePath]),D=u.concat(M);f.children&&f.children.length>0&&(Ie(f.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${I}".`),vf(f.children,h,D,I,w)),!(f.path==null&&!f.index)&&h.push({path:I,score:qp(I,f.index),routesMeta:D})};return i.forEach((f,S)=>{var w;if(f.path===""||!((w=f.path)!=null&&w.includes("?")))m(f,S);else for(let p of kf(f.path))m(f,S,!0,p)}),h}function kf(i){let h=i.split("/");if(h.length===0)return[];let[u,...r]=h,c=u.endsWith("?"),m=u.replace(/\?$/,"");if(r.length===0)return c?[m,""]:[m];let f=kf(r.join("/")),S=[];return S.push(...f.map(w=>w===""?m:[m,w].join("/"))),c&&S.push(...f),S.map(w=>i.startsWith("/")&&w===""?"/":w)}function Cp(i){i.sort((h,u)=>h.score!==u.score?u.score-h.score:Kp(h.routesMeta.map(r=>r.childrenIndex),u.routesMeta.map(r=>r.childrenIndex)))}var jp=/^:[\w-]+$/,Np=3,Op=2,Bp=1,Dp=10,Up=-2,uf=i=>i==="*";function qp(i,h){let u=i.split("/"),r=u.length;return u.some(uf)&&(r+=Up),h&&(r+=Op),u.filter(c=>!uf(c)).reduce((c,m)=>c+(jp.test(m)?Np:m===""?Bp:Dp),r)}function Kp(i,h){return i.length===h.length&&i.slice(0,-1).every((r,c)=>r===h[c])?i[i.length-1]-h[h.length-1]:0}function _p(i,h,u=!1){let{routesMeta:r}=i,c={},m="/",f=[];for(let S=0;S<r.length;++S){let w=r[S],p=S===r.length-1,M=m==="/"?h:h.slice(m.length)||"/",I=ho({path:w.relativePath,caseSensitive:w.caseSensitive,end:p},M),D=w.route;if(!I&&p&&u&&!r[r.length-1].route.index&&(I=ho({path:w.relativePath,caseSensitive:w.caseSensitive,end:!1},M)),!I)return null;Object.assign(c,I.params),f.push({params:c,pathname:sa([m,I.pathname]),pathnameBase:Vp(sa([m,I.pathnameBase])),route:D}),I.pathnameBase!=="/"&&(m=sa([m,I.pathnameBase]))}return f}function ho(i,h){typeof i=="string"&&(i={path:i,caseSensitive:!1,end:!0});let[u,r]=Hp(i.path,i.caseSensitive,i.end),c=h.match(u);if(!c)return null;let m=c[0],f=m.replace(/(.)\/+$/,"$1"),S=c.slice(1);return{params:r.reduce((p,{paramName:M,isOptional:I},D)=>{if(M==="*"){let q=S[D]||"";f=m.slice(0,m.length-q.length).replace(/(.)\/+$/,"$1")}const U=S[D];return I&&!U?p[M]=void 0:p[M]=(U||"").replace(/%2F/g,"/"),p},{}),pathname:m,pathnameBase:f,pattern:i}}function Hp(i,h=!1,u=!0){Ct(i==="*"||!i.endsWith("*")||i.endsWith("/*"),`Route path "${i}" will be treated as if it were "${i.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${i.replace(/\*$/,"/*")}".`);let r=[],c="^"+i.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(f,S,w)=>(r.push({paramName:S,isOptional:w!=null}),w?"/?([^\\/]+)?":"/([^\\/]+)")).replace(/\/([\w-]+)\?(\/|$)/g,"(/$1)?$2");return i.endsWith("*")?(r.push({paramName:"*"}),c+=i==="*"||i==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):u?c+="\\/*$":i!==""&&i!=="/"&&(c+="(?:(?=\\/|$))"),[new RegExp(c,h?void 0:"i"),r]}function Lp(i){try{return i.split("/").map(h=>decodeURIComponent(h).replace(/\//g,"%2F")).join("/")}catch(h){return Ct(!1,`The URL path "${i}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${h}).`),i}}function na(i,h){if(h==="/")return i;if(!i.toLowerCase().startsWith(h.toLowerCase()))return null;let u=h.endsWith("/")?h.length-1:h.length,r=i.charAt(u);return r&&r!=="/"?null:i.slice(u)||"/"}var Gp=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i;function Yp(i,h="/"){let{pathname:u,search:r="",hash:c=""}=typeof i=="string"?$a(i):i,m;return u?(u=u.replace(/\/\/+/g,"/"),u.startsWith("/")?m=cf(u.substring(1),"/"):m=cf(u,h)):m=h,{pathname:m,search:Xp(r),hash:Qp(c)}}function cf(i,h){let u=h.replace(/\/+$/,"").split("/");return i.split("/").forEach(c=>{c===".."?u.length>1&&u.pop():c!=="."&&u.push(c)}),u.length>1?u.join("/"):"/"}function Ur(i,h,u,r){return`Cannot include a '${i}' character in a manually specified \`to.${h}\` field [${JSON.stringify(r)}].  Please separate it out to the \`to.${u}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function Wp(i){return i.filter((h,u)=>u===0||h.route.path&&h.route.path.length>0)}function Sf(i){let h=Wp(i);return h.map((u,r)=>r===h.length-1?u.pathname:u.pathnameBase)}function Tf(i,h,u,r=!1){let c;typeof i=="string"?c=$a(i):(c={...i},Ie(!c.pathname||!c.pathname.includes("?"),Ur("?","pathname","search",c)),Ie(!c.pathname||!c.pathname.includes("#"),Ur("#","pathname","hash",c)),Ie(!c.search||!c.search.includes("#"),Ur("#","search","hash",c)));let m=i===""||c.pathname==="",f=m?"/":c.pathname,S;if(f==null)S=u;else{let I=h.length-1;if(!r&&f.startsWith("..")){let D=f.split("/");for(;D[0]==="..";)D.shift(),I-=1;c.pathname=D.join("/")}S=I>=0?h[I]:"/"}let w=Yp(c,S),p=f&&f!=="/"&&f.endsWith("/"),M=(m||f===".")&&u.endsWith("/");return!w.pathname.endsWith("/")&&(p||M)&&(w.pathname+="/"),w}var sa=i=>i.join("/").replace(/\/\/+/g,"/"),Vp=i=>i.replace(/\/+$/,"").replace(/^\/*/,"/"),Xp=i=>!i||i==="?"?"":i.startsWith("?")?i:"?"+i,Qp=i=>!i||i==="#"?"":i.startsWith("#")?i:"#"+i,Zp=class{constructor(i,h,u,r=!1){this.status=i,this.statusText=h||"",this.internal=r,u instanceof Error?(this.data=u.toString(),this.error=u):this.data=u}};function Jp(i){return i!=null&&typeof i.status=="number"&&typeof i.statusText=="string"&&typeof i.internal=="boolean"&&"data"in i}function Fp(i){return i.map(h=>h.route.path).filter(Boolean).join("/").replace(/\/\/*/g,"/")||"/"}var Rf=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";function If(i,h){let u=i;if(typeof u!="string"||!Gp.test(u))return{absoluteURL:void 0,isExternal:!1,to:u};let r=u,c=!1;if(Rf)try{let m=new URL(window.location.href),f=u.startsWith("//")?new URL(m.protocol+u):new URL(u),S=na(f.pathname,h);f.origin===m.origin&&S!=null?u=S+f.search+f.hash:c=!0}catch{Ct(!1,`<Link to="${u}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}return{absoluteURL:r,isExternal:c,to:u}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");var Af=["POST","PUT","PATCH","DELETE"];new Set(Af);var $p=["GET",...Af];new Set($p);var qs=E.createContext(null);qs.displayName="DataRouter";var uo=E.createContext(null);uo.displayName="DataRouterState";var Pp=E.createContext(!1),Ef=E.createContext({isTransitioning:!1});Ef.displayName="ViewTransition";var eb=E.createContext(new Map);eb.displayName="Fetchers";var tb=E.createContext(null);tb.displayName="Await";var Rt=E.createContext(null);Rt.displayName="Navigation";var qn=E.createContext(null);qn.displayName="Location";var Ut=E.createContext({outlet:null,matches:[],isDataRoute:!1});Ut.displayName="Route";var Yr=E.createContext(null);Yr.displayName="RouteError";var Mf="REACT_ROUTER_ERROR",ab="REDIRECT",sb="ROUTE_ERROR_RESPONSE";function nb(i){if(i.startsWith(`${Mf}:${ab}:{`))try{let h=JSON.parse(i.slice(28));if(typeof h=="object"&&h&&typeof h.status=="number"&&typeof h.statusText=="string"&&typeof h.location=="string"&&typeof h.reloadDocument=="boolean"&&typeof h.replace=="boolean")return h}catch{}}function lb(i){if(i.startsWith(`${Mf}:${sb}:{`))try{let h=JSON.parse(i.slice(40));if(typeof h=="object"&&h&&typeof h.status=="number"&&typeof h.statusText=="string")return new Zp(h.status,h.statusText,h.data)}catch{}}function ob(i,{relative:h}={}){Ie(Kn(),"useHref() may be used only in the context of a <Router> component.");let{basename:u,navigator:r}=E.useContext(Rt),{hash:c,pathname:m,search:f}=_n(i,{relative:h}),S=m;return u!=="/"&&(S=m==="/"?u:sa([u,m])),r.createHref({pathname:S,search:f,hash:c})}function Kn(){return E.useContext(qn)!=null}function za(){return Ie(Kn(),"useLocation() may be used only in the context of a <Router> component."),E.useContext(qn).location}var zf="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function Cf(i){E.useContext(Rt).static||E.useLayoutEffect(i)}function Wr(){let{isDataRoute:i}=E.useContext(Ut);return i?wb():ib()}function ib(){Ie(Kn(),"useNavigate() may be used only in the context of a <Router> component.");let i=E.useContext(qs),{basename:h,navigator:u}=E.useContext(Rt),{matches:r}=E.useContext(Ut),{pathname:c}=za(),m=JSON.stringify(Sf(r)),f=E.useRef(!1);return Cf(()=>{f.current=!0}),E.useCallback((w,p={})=>{if(Ct(f.current,zf),!f.current)return;if(typeof w=="number"){u.go(w);return}let M=Tf(w,JSON.parse(m),c,p.relative==="path");i==null&&h!=="/"&&(M.pathname=M.pathname==="/"?h:sa([h,M.pathname])),(p.replace?u.replace:u.push)(M,p.state,p)},[h,u,m,c,i])}E.createContext(null);function jf(){let{matches:i}=E.useContext(Ut),h=i[i.length-1];return h?h.params:{}}function _n(i,{relative:h}={}){let{matches:u}=E.useContext(Ut),{pathname:r}=za(),c=JSON.stringify(Sf(u));return E.useMemo(()=>Tf(i,JSON.parse(c),r,h==="path"),[i,c,r,h])}function rb(i,h){return Nf(i,h)}function Nf(i,h,u,r,c){var J;Ie(Kn(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:m}=E.useContext(Rt),{matches:f}=E.useContext(Ut),S=f[f.length-1],w=S?S.params:{},p=S?S.pathname:"/",M=S?S.pathnameBase:"/",I=S&&S.route;{let H=I&&I.path||"";Bf(p,!I||H.endsWith("*")||H.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${p}" (under <Route path="${H}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${H}"> to <Route path="${H==="/"?"*":`${H}/*`}">.`)}let D=za(),U;if(h){let H=typeof h=="string"?$a(h):h;Ie(M==="/"||((J=H.pathname)==null?void 0:J.startsWith(M)),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${M}" but pathname "${H.pathname}" was given in the \`location\` prop.`),U=H}else U=D;let q=U.pathname||"/",B=q;if(M!=="/"){let H=M.replace(/^\//,"").split("/");B="/"+q.replace(/^\//,"").split("/").slice(H.length).join("/")}let L=xf(i,{pathname:B});Ct(I||L!=null,`No routes matched location "${U.pathname}${U.search}${U.hash}" `),Ct(L==null||L[L.length-1].route.element!==void 0||L[L.length-1].route.Component!==void 0||L[L.length-1].route.lazy!==void 0,`Matched leaf route at location "${U.pathname}${U.search}${U.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let V=fb(L&&L.map(H=>Object.assign({},H,{params:Object.assign({},w,H.params),pathname:sa([M,m.encodeLocation?m.encodeLocation(H.pathname.replace(/\?/g,"%3F").replace(/#/g,"%23")).pathname:H.pathname]),pathnameBase:H.pathnameBase==="/"?M:sa([M,m.encodeLocation?m.encodeLocation(H.pathnameBase.replace(/\?/g,"%3F").replace(/#/g,"%23")).pathname:H.pathnameBase])})),f,u,r,c);return h&&V?E.createElement(qn.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...U},navigationType:"POP"}},V):V}function db(){let i=yb(),h=Jp(i)?`${i.status} ${i.statusText}`:i instanceof Error?i.message:JSON.stringify(i),u=i instanceof Error?i.stack:null,r="rgba(200,200,200, 0.5)",c={padding:"0.5rem",backgroundColor:r},m={padding:"2px 4px",backgroundColor:r},f=null;return console.error("Error handled by React Router default ErrorBoundary:",i),f=E.createElement(E.Fragment,null,E.createElement("p",null,"💿 Hey developer 👋"),E.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",E.createElement("code",{style:m},"ErrorBoundary")," or"," ",E.createElement("code",{style:m},"errorElement")," prop on your route.")),E.createElement(E.Fragment,null,E.createElement("h2",null,"Unexpected Application Error!"),E.createElement("h3",{style:{fontStyle:"italic"}},h),u?E.createElement("pre",{style:c},u):null,f)}var hb=E.createElement(db,null),Of=class extends E.Component{constructor(i){super(i),this.state={location:i.location,revalidation:i.revalidation,error:i.error}}static getDerivedStateFromError(i){return{error:i}}static getDerivedStateFromProps(i,h){return h.location!==i.location||h.revalidation!=="idle"&&i.revalidation==="idle"?{error:i.error,location:i.location,revalidation:i.revalidation}:{error:i.error!==void 0?i.error:h.error,location:h.location,revalidation:i.revalidation||h.revalidation}}componentDidCatch(i,h){this.props.onError?this.props.onError(i,h):console.error("React Router caught the following error during render",i)}render(){let i=this.state.error;if(this.context&&typeof i=="object"&&i&&"digest"in i&&typeof i.digest=="string"){const u=lb(i.digest);u&&(i=u)}let h=i!==void 0?E.createElement(Ut.Provider,{value:this.props.routeContext},E.createElement(Yr.Provider,{value:i,children:this.props.component})):this.props.children;return this.context?E.createElement(ub,{error:i},h):h}};Of.contextType=Pp;var qr=new WeakMap;function ub({children:i,error:h}){let{basename:u}=E.useContext(Rt);if(typeof h=="object"&&h&&"digest"in h&&typeof h.digest=="string"){let r=nb(h.digest);if(r){let c=qr.get(h);if(c)throw c;let m=If(r.location,u);if(Rf&&!qr.get(h))if(m.isExternal||r.reloadDocument)window.location.href=m.absoluteURL||m.to;else{const f=Promise.resolve().then(()=>window.__reactRouterDataRouter.navigate(m.to,{replace:r.replace}));throw qr.set(h,f),f}return E.createElement("meta",{httpEquiv:"refresh",content:`0;url=${m.absoluteURL||m.to}`})}}return i}function cb({routeContext:i,match:h,children:u}){let r=E.useContext(qs);return r&&r.static&&r.staticContext&&(h.route.errorElement||h.route.ErrorBoundary)&&(r.staticContext._deepestRenderedBoundaryId=h.route.id),E.createElement(Ut.Provider,{value:i},u)}function fb(i,h=[],u=null,r=null,c=null){if(i==null){if(!u)return null;if(u.errors)i=u.matches;else if(h.length===0&&!u.initialized&&u.matches.length>0)i=u.matches;else return null}let m=i,f=u==null?void 0:u.errors;if(f!=null){let M=m.findIndex(I=>I.route.id&&(f==null?void 0:f[I.route.id])!==void 0);Ie(M>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(f).join(",")}`),m=m.slice(0,Math.min(m.length,M+1))}let S=!1,w=-1;if(u)for(let M=0;M<m.length;M++){let I=m[M];if((I.route.HydrateFallback||I.route.hydrateFallbackElement)&&(w=M),I.route.id){let{loaderData:D,errors:U}=u,q=I.route.loader&&!D.hasOwnProperty(I.route.id)&&(!U||U[I.route.id]===void 0);if(I.route.lazy||q){S=!0,w>=0?m=m.slice(0,w+1):m=[m[0]];break}}}let p=u&&r?(M,I)=>{var D,U;r(M,{location:u.location,params:((U=(D=u.matches)==null?void 0:D[0])==null?void 0:U.params)??{},unstable_pattern:Fp(u.matches),errorInfo:I})}:void 0;return m.reduceRight((M,I,D)=>{let U,q=!1,B=null,L=null;u&&(U=f&&I.route.id?f[I.route.id]:void 0,B=I.route.errorElement||hb,S&&(w<0&&D===0?(Bf("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),q=!0,L=null):w===D&&(q=!0,L=I.route.hydrateFallbackElement||null)));let V=h.concat(m.slice(0,D+1)),J=()=>{let H;return U?H=B:q?H=L:I.route.Component?H=E.createElement(I.route.Component,null):I.route.element?H=I.route.element:H=M,E.createElement(cb,{match:I,routeContext:{outlet:M,matches:V,isDataRoute:u!=null},children:H})};return u&&(I.route.ErrorBoundary||I.route.errorElement||D===0)?E.createElement(Of,{location:u.location,revalidation:u.revalidation,component:B,error:U,children:J(),routeContext:{outlet:null,matches:V,isDataRoute:!0},onError:p}):J()},null)}function Vr(i){return`${i} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function mb(i){let h=E.useContext(qs);return Ie(h,Vr(i)),h}function gb(i){let h=E.useContext(uo);return Ie(h,Vr(i)),h}function pb(i){let h=E.useContext(Ut);return Ie(h,Vr(i)),h}function Xr(i){let h=pb(i),u=h.matches[h.matches.length-1];return Ie(u.route.id,`${i} can only be used on routes that contain a unique "id"`),u.route.id}function bb(){return Xr("useRouteId")}function yb(){var r;let i=E.useContext(Yr),h=gb("useRouteError"),u=Xr("useRouteError");return i!==void 0?i:(r=h.errors)==null?void 0:r[u]}function wb(){let{router:i}=mb("useNavigate"),h=Xr("useNavigate"),u=E.useRef(!1);return Cf(()=>{u.current=!0}),E.useCallback(async(c,m={})=>{Ct(u.current,zf),u.current&&(typeof c=="number"?await i.navigate(c):await i.navigate(c,{fromRouteId:h,...m}))},[i,h])}var ff={};function Bf(i,h,u){!h&&!ff[i]&&(ff[i]=!0,Ct(!1,u))}E.memo(xb);function xb({routes:i,future:h,state:u,onError:r}){return Nf(i,void 0,u,r,h)}function oo(i){Ie(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function vb({basename:i="/",children:h=null,location:u,navigationType:r="POP",navigator:c,static:m=!1,unstable_useTransitions:f}){Ie(!Kn(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let S=i.replace(/^\/*/,"/"),w=E.useMemo(()=>({basename:S,navigator:c,static:m,unstable_useTransitions:f,future:{}}),[S,c,m,f]);typeof u=="string"&&(u=$a(u));let{pathname:p="/",search:M="",hash:I="",state:D=null,key:U="default"}=u,q=E.useMemo(()=>{let B=na(p,S);return B==null?null:{location:{pathname:B,search:M,hash:I,state:D,key:U},navigationType:r}},[S,p,M,I,D,U,r]);return Ct(q!=null,`<Router basename="${S}"> is not able to match the URL "${p}${M}${I}" because it does not start with the basename, so the <Router> won't render anything.`),q==null?null:E.createElement(Rt.Provider,{value:w},E.createElement(qn.Provider,{children:h,value:q}))}function kb({children:i,location:h}){return rb(Lr(i),h)}function Lr(i,h=[]){let u=[];return E.Children.forEach(i,(r,c)=>{if(!E.isValidElement(r))return;let m=[...h,c];if(r.type===E.Fragment){u.push.apply(u,Lr(r.props.children,m));return}Ie(r.type===oo,`[${typeof r.type=="string"?r.type:r.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),Ie(!r.props.index||!r.props.children,"An index route cannot have child routes.");let f={id:r.props.id||m.join("-"),caseSensitive:r.props.caseSensitive,element:r.props.element,Component:r.props.Component,index:r.props.index,path:r.props.path,middleware:r.props.middleware,loader:r.props.loader,action:r.props.action,hydrateFallbackElement:r.props.hydrateFallbackElement,HydrateFallback:r.props.HydrateFallback,errorElement:r.props.errorElement,ErrorBoundary:r.props.ErrorBoundary,hasErrorBoundary:r.props.hasErrorBoundary===!0||r.props.ErrorBoundary!=null||r.props.errorElement!=null,shouldRevalidate:r.props.shouldRevalidate,handle:r.props.handle,lazy:r.props.lazy};r.props.children&&(f.children=Lr(r.props.children,m)),u.push(f)}),u}var io="get",ro="application/x-www-form-urlencoded";function co(i){return typeof HTMLElement<"u"&&i instanceof HTMLElement}function Sb(i){return co(i)&&i.tagName.toLowerCase()==="button"}function Tb(i){return co(i)&&i.tagName.toLowerCase()==="form"}function Rb(i){return co(i)&&i.tagName.toLowerCase()==="input"}function Ib(i){return!!(i.metaKey||i.altKey||i.ctrlKey||i.shiftKey)}function Ab(i,h){return i.button===0&&(!h||h==="_self")&&!Ib(i)}var lo=null;function Eb(){if(lo===null)try{new FormData(document.createElement("form"),0),lo=!1}catch{lo=!0}return lo}var Mb=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function Kr(i){return i!=null&&!Mb.has(i)?(Ct(!1,`"${i}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${ro}"`),null):i}function zb(i,h){let u,r,c,m,f;if(Tb(i)){let S=i.getAttribute("action");r=S?na(S,h):null,u=i.getAttribute("method")||io,c=Kr(i.getAttribute("enctype"))||ro,m=new FormData(i)}else if(Sb(i)||Rb(i)&&(i.type==="submit"||i.type==="image")){let S=i.form;if(S==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let w=i.getAttribute("formaction")||S.getAttribute("action");if(r=w?na(w,h):null,u=i.getAttribute("formmethod")||S.getAttribute("method")||io,c=Kr(i.getAttribute("formenctype"))||Kr(S.getAttribute("enctype"))||ro,m=new FormData(S,i),!Eb()){let{name:p,type:M,value:I}=i;if(M==="image"){let D=p?`${p}.`:"";m.append(`${D}x`,"0"),m.append(`${D}y`,"0")}else p&&m.append(p,I)}}else{if(co(i))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');u=io,r=null,c=ro,f=i}return m&&c==="text/plain"&&(f=m,m=void 0),{action:r,method:u.toLowerCase(),encType:c,formData:m,body:f}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function Qr(i,h){if(i===!1||i===null||typeof i>"u")throw new Error(h)}function Cb(i,h,u,r){let c=typeof i=="string"?new URL(i,typeof window>"u"?"server://singlefetch/":window.location.origin):i;return u?c.pathname.endsWith("/")?c.pathname=`${c.pathname}_.${r}`:c.pathname=`${c.pathname}.${r}`:c.pathname==="/"?c.pathname=`_root.${r}`:h&&na(c.pathname,h)==="/"?c.pathname=`${h.replace(/\/$/,"")}/_root.${r}`:c.pathname=`${c.pathname.replace(/\/$/,"")}.${r}`,c}async function jb(i,h){if(i.id in h)return h[i.id];try{let u=await import(i.module);return h[i.id]=u,u}catch(u){return console.error(`Error loading route module \`${i.module}\`, reloading page...`),console.error(u),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function Nb(i){return i==null?!1:i.href==null?i.rel==="preload"&&typeof i.imageSrcSet=="string"&&typeof i.imageSizes=="string":typeof i.rel=="string"&&typeof i.href=="string"}async function Ob(i,h,u){let r=await Promise.all(i.map(async c=>{let m=h.routes[c.route.id];if(m){let f=await jb(m,u);return f.links?f.links():[]}return[]}));return qb(r.flat(1).filter(Nb).filter(c=>c.rel==="stylesheet"||c.rel==="preload").map(c=>c.rel==="stylesheet"?{...c,rel:"prefetch",as:"style"}:{...c,rel:"prefetch"}))}function mf(i,h,u,r,c,m){let f=(w,p)=>u[p]?w.route.id!==u[p].route.id:!0,S=(w,p)=>{var M;return u[p].pathname!==w.pathname||((M=u[p].route.path)==null?void 0:M.endsWith("*"))&&u[p].params["*"]!==w.params["*"]};return m==="assets"?h.filter((w,p)=>f(w,p)||S(w,p)):m==="data"?h.filter((w,p)=>{var I;let M=r.routes[w.route.id];if(!M||!M.hasLoader)return!1;if(f(w,p)||S(w,p))return!0;if(w.route.shouldRevalidate){let D=w.route.shouldRevalidate({currentUrl:new URL(c.pathname+c.search+c.hash,window.origin),currentParams:((I=u[0])==null?void 0:I.params)||{},nextUrl:new URL(i,window.origin),nextParams:w.params,defaultShouldRevalidate:!0});if(typeof D=="boolean")return D}return!0}):[]}function Bb(i,h,{includeHydrateFallback:u}={}){return Db(i.map(r=>{let c=h.routes[r.route.id];if(!c)return[];let m=[c.module];return c.clientActionModule&&(m=m.concat(c.clientActionModule)),c.clientLoaderModule&&(m=m.concat(c.clientLoaderModule)),u&&c.hydrateFallbackModule&&(m=m.concat(c.hydrateFallbackModule)),c.imports&&(m=m.concat(c.imports)),m}).flat(1))}function Db(i){return[...new Set(i)]}function Ub(i){let h={},u=Object.keys(i).sort();for(let r of u)h[r]=i[r];return h}function qb(i,h){let u=new Set;return new Set(h),i.reduce((r,c)=>{let m=JSON.stringify(Ub(c));return u.has(m)||(u.add(m),r.push({key:m,link:c})),r},[])}function Df(){let i=E.useContext(qs);return Qr(i,"You must render this element inside a <DataRouterContext.Provider> element"),i}function Kb(){let i=E.useContext(uo);return Qr(i,"You must render this element inside a <DataRouterStateContext.Provider> element"),i}var Zr=E.createContext(void 0);Zr.displayName="FrameworkContext";function Uf(){let i=E.useContext(Zr);return Qr(i,"You must render this element inside a <HydratedRouter> element"),i}function _b(i,h){let u=E.useContext(Zr),[r,c]=E.useState(!1),[m,f]=E.useState(!1),{onFocus:S,onBlur:w,onMouseEnter:p,onMouseLeave:M,onTouchStart:I}=h,D=E.useRef(null);E.useEffect(()=>{if(i==="render"&&f(!0),i==="viewport"){let B=V=>{V.forEach(J=>{f(J.isIntersecting)})},L=new IntersectionObserver(B,{threshold:.5});return D.current&&L.observe(D.current),()=>{L.disconnect()}}},[i]),E.useEffect(()=>{if(r){let B=setTimeout(()=>{f(!0)},100);return()=>{clearTimeout(B)}}},[r]);let U=()=>{c(!0)},q=()=>{c(!1),f(!1)};return u?i!=="intent"?[m,D,{}]:[m,D,{onFocus:Bn(S,U),onBlur:Bn(w,q),onMouseEnter:Bn(p,U),onMouseLeave:Bn(M,q),onTouchStart:Bn(I,U)}]:[!1,D,{}]}function Bn(i,h){return u=>{i&&i(u),u.defaultPrevented||h(u)}}function Hb({page:i,...h}){let{router:u}=Df(),r=E.useMemo(()=>xf(u.routes,i,u.basename),[u.routes,i,u.basename]);return r?E.createElement(Gb,{page:i,matches:r,...h}):null}function Lb(i){let{manifest:h,routeModules:u}=Uf(),[r,c]=E.useState([]);return E.useEffect(()=>{let m=!1;return Ob(i,h,u).then(f=>{m||c(f)}),()=>{m=!0}},[i,h,u]),r}function Gb({page:i,matches:h,...u}){let r=za(),{future:c,manifest:m,routeModules:f}=Uf(),{basename:S}=Df(),{loaderData:w,matches:p}=Kb(),M=E.useMemo(()=>mf(i,h,p,m,r,"data"),[i,h,p,m,r]),I=E.useMemo(()=>mf(i,h,p,m,r,"assets"),[i,h,p,m,r]),D=E.useMemo(()=>{if(i===r.pathname+r.search+r.hash)return[];let B=new Set,L=!1;if(h.forEach(J=>{var Q;let H=m.routes[J.route.id];!H||!H.hasLoader||(!M.some(oe=>oe.route.id===J.route.id)&&J.route.id in w&&((Q=f[J.route.id])!=null&&Q.shouldRevalidate)||H.hasClientLoader?L=!0:B.add(J.route.id))}),B.size===0)return[];let V=Cb(i,S,c.unstable_trailingSlashAwareDataRequests,"data");return L&&B.size>0&&V.searchParams.set("_routes",h.filter(J=>B.has(J.route.id)).map(J=>J.route.id).join(",")),[V.pathname+V.search]},[S,c.unstable_trailingSlashAwareDataRequests,w,r,m,M,h,i,f]),U=E.useMemo(()=>Bb(I,m),[I,m]),q=Lb(I);return E.createElement(E.Fragment,null,D.map(B=>E.createElement("link",{key:B,rel:"prefetch",as:"fetch",href:B,...u})),U.map(B=>E.createElement("link",{key:B,rel:"modulepreload",href:B,...u})),q.map(({key:B,link:L})=>E.createElement("link",{key:B,nonce:u.nonce,...L,crossOrigin:L.crossOrigin??u.crossOrigin})))}function Yb(...i){return h=>{i.forEach(u=>{typeof u=="function"?u(h):u!=null&&(u.current=h)})}}var Wb=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{Wb&&(window.__reactRouterVersion="7.13.0")}catch{}function Vb({basename:i,children:h,unstable_useTransitions:u,window:r}){let c=E.useRef();c.current==null&&(c.current=Ip({window:r,v5Compat:!0}));let m=c.current,[f,S]=E.useState({action:m.action,location:m.location}),w=E.useCallback(p=>{u===!1?S(p):E.startTransition(()=>S(p))},[u]);return E.useLayoutEffect(()=>m.listen(w),[m,w]),E.createElement(vb,{basename:i,children:h,location:f.location,navigationType:f.action,navigator:m,unstable_useTransitions:u})}var qf=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,zt=E.forwardRef(function({onClick:h,discover:u="render",prefetch:r="none",relative:c,reloadDocument:m,replace:f,state:S,target:w,to:p,preventScrollReset:M,viewTransition:I,unstable_defaultShouldRevalidate:D,...U},q){let{basename:B,unstable_useTransitions:L}=E.useContext(Rt),V=typeof p=="string"&&qf.test(p),J=If(p,B);p=J.to;let H=ob(p,{relative:c}),[Q,oe,Te]=_b(r,U),P=Jb(p,{replace:f,state:S,target:w,preventScrollReset:M,relative:c,viewTransition:I,unstable_defaultShouldRevalidate:D,unstable_useTransitions:L});function Me(mt){h&&h(mt),mt.defaultPrevented||P(mt)}let _e=E.createElement("a",{...U,...Te,href:J.absoluteURL||H,onClick:J.isExternal||m?h:Me,ref:Yb(q,oe),target:w,"data-discover":!V&&u==="render"?"true":void 0});return Q&&!V?E.createElement(E.Fragment,null,_e,E.createElement(Hb,{page:H})):_e});zt.displayName="Link";var Xb=E.forwardRef(function({"aria-current":h="page",caseSensitive:u=!1,className:r="",end:c=!1,style:m,to:f,viewTransition:S,children:w,...p},M){let I=_n(f,{relative:p.relative}),D=za(),U=E.useContext(uo),{navigator:q,basename:B}=E.useContext(Rt),L=U!=null&&ty(I)&&S===!0,V=q.encodeLocation?q.encodeLocation(I).pathname:I.pathname,J=D.pathname,H=U&&U.navigation&&U.navigation.location?U.navigation.location.pathname:null;u||(J=J.toLowerCase(),H=H?H.toLowerCase():null,V=V.toLowerCase()),H&&B&&(H=na(H,B)||H);const Q=V!=="/"&&V.endsWith("/")?V.length-1:V.length;let oe=J===V||!c&&J.startsWith(V)&&J.charAt(Q)==="/",Te=H!=null&&(H===V||!c&&H.startsWith(V)&&H.charAt(V.length)==="/"),P={isActive:oe,isPending:Te,isTransitioning:L},Me=oe?h:void 0,_e;typeof r=="function"?_e=r(P):_e=[r,oe?"active":null,Te?"pending":null,L?"transitioning":null].filter(Boolean).join(" ");let mt=typeof m=="function"?m(P):m;return E.createElement(zt,{...p,"aria-current":Me,className:_e,ref:M,style:mt,to:f,viewTransition:S},typeof w=="function"?w(P):w)});Xb.displayName="NavLink";var Qb=E.forwardRef(({discover:i="render",fetcherKey:h,navigate:u,reloadDocument:r,replace:c,state:m,method:f=io,action:S,onSubmit:w,relative:p,preventScrollReset:M,viewTransition:I,unstable_defaultShouldRevalidate:D,...U},q)=>{let{unstable_useTransitions:B}=E.useContext(Rt),L=Pb(),V=ey(S,{relative:p}),J=f.toLowerCase()==="get"?"get":"post",H=typeof S=="string"&&qf.test(S),Q=oe=>{if(w&&w(oe),oe.defaultPrevented)return;oe.preventDefault();let Te=oe.nativeEvent.submitter,P=(Te==null?void 0:Te.getAttribute("formmethod"))||f,Me=()=>L(Te||oe.currentTarget,{fetcherKey:h,method:P,navigate:u,replace:c,state:m,relative:p,preventScrollReset:M,viewTransition:I,unstable_defaultShouldRevalidate:D});B&&u!==!1?E.startTransition(()=>Me()):Me()};return E.createElement("form",{ref:q,method:J,action:V,onSubmit:r?w:Q,...U,"data-discover":!H&&i==="render"?"true":void 0})});Qb.displayName="Form";function Zb(i){return`${i} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Kf(i){let h=E.useContext(qs);return Ie(h,Zb(i)),h}function Jb(i,{target:h,replace:u,state:r,preventScrollReset:c,relative:m,viewTransition:f,unstable_defaultShouldRevalidate:S,unstable_useTransitions:w}={}){let p=Wr(),M=za(),I=_n(i,{relative:m});return E.useCallback(D=>{if(Ab(D,h)){D.preventDefault();let U=u!==void 0?u:Un(M)===Un(I),q=()=>p(i,{replace:U,state:r,preventScrollReset:c,relative:m,viewTransition:f,unstable_defaultShouldRevalidate:S});w?E.startTransition(()=>q()):q()}},[M,p,I,u,r,h,i,c,m,f,S,w])}var Fb=0,$b=()=>`__${String(++Fb)}__`;function Pb(){let{router:i}=Kf("useSubmit"),{basename:h}=E.useContext(Rt),u=bb(),r=i.fetch,c=i.navigate;return E.useCallback(async(m,f={})=>{let{action:S,method:w,encType:p,formData:M,body:I}=zb(m,h);if(f.navigate===!1){let D=f.fetcherKey||$b();await r(D,u,f.action||S,{unstable_defaultShouldRevalidate:f.unstable_defaultShouldRevalidate,preventScrollReset:f.preventScrollReset,formData:M,body:I,formMethod:f.method||w,formEncType:f.encType||p,flushSync:f.flushSync})}else await c(f.action||S,{unstable_defaultShouldRevalidate:f.unstable_defaultShouldRevalidate,preventScrollReset:f.preventScrollReset,formData:M,body:I,formMethod:f.method||w,formEncType:f.encType||p,replace:f.replace,state:f.state,fromRouteId:u,flushSync:f.flushSync,viewTransition:f.viewTransition})},[r,c,h,u])}function ey(i,{relative:h}={}){let{basename:u}=E.useContext(Rt),r=E.useContext(Ut);Ie(r,"useFormAction must be used inside a RouteContext");let[c]=r.matches.slice(-1),m={..._n(i||".",{relative:h})},f=za();if(i==null){m.search=f.search;let S=new URLSearchParams(m.search),w=S.getAll("index");if(w.some(M=>M==="")){S.delete("index"),w.filter(I=>I).forEach(I=>S.append("index",I));let M=S.toString();m.search=M?`?${M}`:""}}return(!i||i===".")&&c.route.index&&(m.search=m.search?m.search.replace(/^\?/,"?index&"):"?index"),u!=="/"&&(m.pathname=m.pathname==="/"?u:sa([u,m.pathname])),Un(m)}function ty(i,{relative:h}={}){let u=E.useContext(Ef);Ie(u!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:r}=Kf("useViewTransitionState"),c=_n(i,{relative:h});if(!u.isTransitioning)return!1;let m=na(u.currentLocation.pathname,r)||u.currentLocation.pathname,f=na(u.nextLocation.pathname,r)||u.nextLocation.pathname;return ho(c.pathname,f)!=null||ho(c.pathname,m)!=null}const ay={id:"home",title:{ko:"홈",en:"Home"},isSinglePost:!1,isActive:!0,posts:[]},sy={id:"prologue",title:{ko:"프롤로그",en:"Prologue"},description:{ko:"여정의 시작",en:"The Beginning of the Journey"},isSinglePost:!0,isActive:!0,posts:[{id:"prologue-1",title:{ko:"프롤로그",en:"Prologue"},subtitle:{ko:"할 수 있다.",en:"I Can Do It."},imageUrl:"https://images.unsplash.com/photo-1520106212299-d99c443e4568?q=80&w=1200&auto=format&fit=crop",isActive:!0,content:{ko:`
        ...
        `},comments:[]}]},gf=""+new URL("Picture1-Df7qmBvz.png",import.meta.url).href,pf=""+new URL("Picture2-CLY9TRtK.png",import.meta.url).href,bf=""+new URL("Picture3-BxKIssuo.png",import.meta.url).href,ny={id:"year1",title:{ko:"1년차, 예비학부",en:"Year 1, Preparatory Program"},shortTitle:{ko:"1년차",en:"Year 1"},description:{ko:"낯선 땅, 첫 번째 겨울",en:"A Strange Land, The First Winter"},isSinglePost:!1,isActive:!0,posts:[{id:"post-100",title:{ko:"새출발",en:"A New Beginning"},subtitle:{ko:"러시아로 향하는 비행기, 그리고 혹독한 신고식",en:"The Flight to Russia, and a Harsh Initiation"},imageUrl:"https://images.unsplash.com/photo-1436491865332-7a61a109cc05?q=80&w=1200&auto=format&fit=crop",isActive:!0,comments:[],content:{ko:`
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const gy=E.forwardRef(({color:i="currentColor",size:h=24,strokeWidth:u=2,absoluteStrokeWidth:r,className:c="",children:m,iconNode:f,...S},w)=>E.createElement("svg",{ref:w,...fy,width:h,height:h,stroke:i,strokeWidth:r?Number(u)*24/Number(h):u,className:Hf("lucide",c),...!m&&!my(S)&&{"aria-hidden":"true"},...S},[...f.map(([p,M])=>E.createElement(p,M)),...Array.isArray(m)?m:[m]]));/**
 * @license lucide-react v0.564.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ze=(i,h)=>{const u=E.forwardRef(({className:r,...c},m)=>E.createElement(gy,{ref:m,iconNode:h,className:Hf(`lucide-${uy(yf(i))}`,`lucide-${i}`,r),...c}));return u.displayName=yf(i),u};/**
 * @license lucide-react v0.564.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 */const Ly=[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]],Lf=Ze("x",Ly),Gf=E.createContext(void 0),Gy=({children:i})=>{const[h,u]=E.useState("ko");return T.jsx(Gf.Provider,{value:{language:h,setLanguage:u},children:i})},Pa=()=>{const i=E.useContext(Gf);if(i===void 0)throw new Error("useLanguage must be used within a LanguageProvider");return i},Yy=({comments:i,onAddComment:h,onUpdateComment:u,onDeleteComment:r})=>{const{language:c}=Pa(),[m,f]=E.useState(""),[S,w]=E.useState(""),[p,M]=E.useState(""),[I,D]=E.useState(null),[U,q]=E.useState(""),B=_f.commentSection,L=Q=>{Q.preventDefault(),m.trim()&&S.trim()&&(h(m,S,p),f(""),w(""),M(""))},V=Q=>{const oe=prompt(B.passwordPrompt[c]);oe===Q.password?(D(Q.id),q(Q.content)):oe!==null&&alert(B.wrongPassword[c])},J=Q=>{const oe=prompt(B.passwordPrompt[c]);oe===Q.password?window.confirm(c==="ko"?"정말 삭제하시겠습니까?":"Are you sure you want to delete this?")&&r(Q.id):oe!==null&&alert(B.wrongPassword[c])},H=()=>{I&&U.trim()&&(u(I,U),D(null),q(""))};return T.jsxs("div",{className:"mt-12 pt-8 border-t border-slate-200",children:[T.jsxs("h3",{className:"text-2xl font-serif text-slate-800 mb-6 flex items-center gap-2",children:[B.title[c]," ",T.jsxs("span",{className:"text-sm font-sans text-slate-500 font-normal",children:["(",i.length,")"]})]}),T.jsx("div",{className:"space-y-6 mb-10",children:i.length===0?T.jsx("div",{className:"text-slate-400 italic text-center py-4 bg-slate-50 rounded-lg",children:B.empty[c]}):i.map(Q=>T.jsxs("div",{className:"bg-white p-4 rounded-lg shadow-sm border border-slate-100",children:[T.jsxs("div",{className:"flex items-center justify-between mb-2",children:[T.jsxs("div",{className:"flex items-center gap-2",children:[T.jsx("div",{className:"w-8 h-8 bg-slate-200 rounded-full flex items-center justify-center text-slate-500",children:T.jsx(Hy,{size:16})}),T.jsx("span",{className:"font-semibold text-slate-700",children:Q.author}),T.jsxs("span",{className:"text-xs text-slate-400",children:["| ",Q.date]})]}),Q.password&&T.jsxs("div",{className:"flex gap-2",children:[T.jsx("button",{onClick:()=>V(Q),className:"p-1 text-slate-400 hover:text-russia-blue transition-colors",title:B.edit[c],children:T.jsx(By,{size:14})}),T.jsx("button",{onClick:()=>J(Q),className:"p-1 text-slate-400 hover:text-red-500 transition-colors",title:B.delete[c],children:T.jsx(Ky,{size:14})})]})]}),I===Q.id?T.jsxs("div",{className:"pl-10 space-y-3",children:[T.jsx("textarea",{value:U,onChange:oe=>q(oe.target.value),className:"w-full px-3 py-2 rounded-md border border-slate-300 focus:outline-none focus:ring-2 focus:ring-russia-blue/50 text-sm h-20 resize-none"}),T.jsxs("div",{className:"flex justify-end gap-2",children:[T.jsxs("button",{onClick:()=>D(null),className:"px-3 py-1 border border-slate-300 text-slate-600 rounded text-xs flex items-center gap-1 hover:bg-slate-50",children:[T.jsx(Lf,{size:12})," ",B.cancel[c]]}),T.jsxs("button",{onClick:H,className:"px-3 py-1 bg-russia-blue text-white rounded text-xs flex items-center gap-1 hover:bg-slate-800",children:[T.jsx(wy,{size:12})," ",B.update[c]]})]})]}):T.jsx("p",{className:"text-slate-600 text-sm leading-relaxed pl-10",children:Q.content})]},Q.id))}),T.jsxs("form",{onSubmit:L,className:"bg-slate-50 p-6 rounded-xl border border-slate-200",children:[T.jsx("h4",{className:"text-sm font-bold text-slate-600 mb-4 uppercase tracking-wider",children:B.formTitle[c]}),T.jsxs("div",{className:"grid gap-4",children:[T.jsxs("div",{className:"flex flex-col md:flex-row gap-4",children:[T.jsx("input",{type:"text",value:S,onChange:Q=>w(Q.target.value),placeholder:B.namePlaceholder[c],className:"w-full md:w-1/3 px-4 py-2 rounded-md border border-slate-300 focus:outline-none focus:ring-2 focus:ring-russia-blue/50 text-sm",required:!0}),T.jsx("input",{type:"password",value:p,onChange:Q=>M(Q.target.value),placeholder:B.passwordPlaceholder[c],className:"w-full md:w-1/3 px-4 py-2 rounded-md border border-slate-300 focus:outline-none focus:ring-2 focus:ring-russia-blue/50 text-sm"})]}),T.jsx("textarea",{value:m,onChange:Q=>f(Q.target.value),placeholder:B.contentPlaceholder[c],className:"w-full px-4 py-3 rounded-md border border-slate-300 focus:outline-none focus:ring-2 focus:ring-russia-blue/50 text-sm h-24 resize-none",required:!0}),T.jsx("div",{className:"flex justify-end",children:T.jsxs("button",{type:"submit",className:"bg-russia-blue hover:bg-slate-800 text-white px-6 py-2 rounded-md text-sm font-semibold transition-colors flex items-center gap-2",children:[T.jsx(Uy,{size:14}),B.submit[c]]})})]})]})]})},Wy=({post:i,categoryTitle:h,onBack:u,prevPost:r,nextPost:c})=>{const{language:m}=Pa(),[f,S]=E.useState(i.comments),w=_f.postView;E.useEffect(()=>{S(i.comments)},[i]);const p=(U,q,B)=>{const L={id:Date.now().toString(),content:U,author:q,date:new Date().toLocaleDateString(),password:B};S([...f,L])},M=(U,q)=>{S(f.map(B=>B.id===U?{...B,content:q}:B))},I=U=>{S(f.filter(q=>q.id!==U))},D=(U,q)=>{if(!U)return T.jsx("div",{className:"w-1/2"});const B=q==="prev";return T.jsxs(zt,{to:`/${U.categoryId}/${U.id}`,className:`w-1/2 p-4 border rounded-lg flex items-center gap-4 hover:bg-slate-50 hover:border-slate-300 transition-colors group ${B?"justify-start":"justify-end"}`,children:[B&&T.jsx(Sy,{className:"text-slate-400 group-hover:text-russia-blue"}),T.jsxs("div",{className:B?"text-left":"text-right",children:[T.jsx("div",{className:"text-xs text-slate-500",children:B?w.prevPost[m]:w.nextPost[m]}),T.jsx("div",{className:"font-serif font-bold text-slate-700 group-hover:text-russia-blue truncate",children:U.title})]}),!B&&T.jsx(Jr,{className:"text-slate-400 group-hover:text-russia-blue"})]})};return T.jsxs("article",{className:"max-w-3xl mx-auto animate-fadeIn pb-20",children:[u&&T.jsxs("button",{onClick:u,className:"mb-8 text-sm text-slate-500 hover:text-russia-blue flex items-center gap-1 transition-colors",children:["← ",w.backToList[m]]}),T.jsxs("header",{className:"mb-10 text-center",children:[T.jsx("span",{className:"inline-block px-3 py-1 bg-slate-100 text-slate-600 rounded-full text-xs font-semibold mb-4 tracking-wide",children:h[m]}),T.jsx("h1",{className:"text-3xl md:text-4xl font-serif font-bold text-slate-900 mb-4 leading-tight",children:i.title[m]}),i.subtitle&&T.jsx("h2",{className:"text-lg md:text-xl text-slate-600 font-light italic mb-6",children:i.subtitle[m]})]}),i.imageUrl&&T.jsxs("div",{className:"mb-10 rounded-xl overflow-hidden shadow-lg aspect-video relative group",children:[T.jsx("img",{src:i.imageUrl,alt:i.title[m],className:"w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700"}),T.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-slate-900/30 to-transparent pointer-events-none"})]}),T.jsx("div",{className:"prose prose-lg prose-slate mx-auto font-serif text-slate-700 leading-loose",dangerouslySetInnerHTML:{__html:i.content[m]}}),T.jsxs("div",{className:"mt-16 pt-8 border-t border-slate-200 flex justify-between items-center gap-4",children:[D(r,"prev"),D(c,"next")]}),T.jsx("div",{className:"mt-16",children:T.jsx(Yy,{comments:f,onAddComment:p,onUpdateComment:M,onDeleteComment:I})})]})},Vy=()=>{const{language:i,setLanguage:h}=Pa(),u=r=>{h(r)};return T.jsxs("div",{className:"flex items-center gap-2",children:[T.jsx("button",{onClick:()=>u("ko"),className:`px-3 py-1 text-sm font-bold rounded-md transition-colors ${i==="ko"?"bg-russia-blue text-white":"bg-slate-200 text-slate-600 hover:bg-slate-300"}`,children:"KO"}),T.jsx("button",{onClick:()=>u("en"),className:`px-3 py-1 text-sm font-bold rounded-md transition-colors ${i==="en"?"bg-russia-blue text-white":"bg-slate-200 text-slate-600 hover:bg-slate-300"}`,children:"EN"})]})},Xy=({onCategoryClick:i,onPostClick:h})=>{const[u,r]=E.useState([]),{language:c}=Pa(),m=f=>{r(S=>S.includes(f)?S.filter(w=>w!==f):[...S,f])};return T.jsxs("div",{className:"animate-fadeIn",children:[T.jsxs("div",{className:"relative h-96 bg-slate-900 rounded-2xl overflow-hidden mb-12 shadow-2xl",children:[T.jsx("img",{src:"https://images.unsplash.com/photo-1455390582262-044cdead277a?q=80&w=1200&auto=format&fit=crop",alt:"Books and Writing",className:"absolute inset-0 w-full h-full object-cover opacity-40"}),T.jsxs("div",{className:"absolute inset-0 flex flex-col justify-center items-center text-center p-6",children:[T.jsx("span",{className:"text-gold-accent font-serif italic mb-4 text-lg animate-pulse",children:"JNP's Memoir"}),T.jsx("h2",{className:"text-4xl md:text-6xl font-serif font-bold text-white mb-6 tracking-tight",children:c==="ko"?"유라시아 견문록":"Eurasian Chronicles"})]})]}),T.jsxs("div",{className:"max-w-3xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-slate-100",children:[T.jsx("div",{className:"flex items-center justify-center mb-8",children:T.jsx(Ny,{className:"text-russia-blue",size:32})}),T.jsx("h3",{className:"text-2xl font-serif font-bold text-center text-slate-800 mb-8",children:_r.title[c]}),T.jsx("div",{className:"prose prose-slate mx-auto text-slate-600 whitespace-pre-wrap leading-loose",dangerouslySetInnerHTML:{__html:_r.content[c]}}),T.jsxs("div",{className:"mt-10 text-right font-serif italic text-slate-500",children:["- ",_r.author]})]}),T.jsxs("div",{className:"max-w-2xl mx-auto mt-16 px-4",children:[T.jsxs("h3",{className:"text-2xl font-serif font-bold text-slate-800 mb-8 text-center flex items-center justify-center gap-2",children:[T.jsx(Ey,{size:24})," ",c==="ko"?"목차":"Table of Contents"]}),T.jsx("div",{className:"flex flex-col bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden divide-y divide-slate-100",children:Fa.filter(f=>f.id!=="home").map(f=>{const S=u.includes(f.id),w=f.isActive!==!1;if(f.isSinglePost){const p=f.posts[0];return T.jsxs(zt,{to:w&&p?`/${f.id}/${p.id}`:"#","aria-disabled":!w,onClick:M=>!w&&M.preventDefault(),className:`w-full px-6 py-5 flex items-center justify-between text-left transition-colors group
                          ...
                          `,children:[T.jsx("span",{className:"font-serif font-bold text-lg group-hover:text-russia-blue transition-colors",children:f.title[c]}),w?T.jsx(Jr,{size:18,className:"text-slate-400 group-hover:text-russia-blue"}):T.jsx(Dn,{size:16})]},f.id)}return T.jsxs("div",{className:"flex flex-col",children:[T.jsxs("button",{disabled:!w,onClick:()=>w&&m(f.id),className:`w-full px-6 py-5 flex items-center justify-between text-left transition-colors group
                              ${w?"hover:bg-slate-50 text-slate-800":"text-slate-300 cursor-not-allowed bg-slate-50/50"}
                          `,children:[T.jsx(zt,{to:`/${f.id}`,className:"font-serif font-bold text-lg group-hover:text-russia-blue transition-colors",children:f.title[c]}),T.jsx("div",{className:"flex items-center gap-2 text-slate-400 group-hover:text-russia-blue",children:w?S?T.jsx(Iy,{size:18}):T.jsx(vy,{size:18}):T.jsx(Dn,{size:16})})]}),w&&S&&T.jsx("div",{className:"bg-slate-50 border-t border-slate-100 animate-fadeIn shadow-inner",children:f.posts.length>0?f.posts.map(p=>T.jsxs(zt,{to:p.isActive!==!1?`/${f.id}/${p.id}`:"#","aria-disabled":p.isActive===!1,onClick:M=>p.isActive===!1&&M.preventDefault(),className:`w-full px-8 py-4 text-left text-sm transition-colors border-b last:border-0 border-slate-100 flex items-center gap-3
                                      ...
                                      `,children:[T.jsx("span",{className:`w-1.5 h-1.5 rounded-full flex-shrink-0 ${p.isActive===!1?"bg-slate-200":"bg-slate-300"}`}),T.jsx("span",{className:"truncate font-medium",children:p.title[c]}),p.isActive===!1&&T.jsx(Dn,{size:12,className:"ml-auto text-slate-300"})]},p.id)):T.jsx("div",{className:"px-8 py-4 text-sm text-slate-400 italic",children:c==="ko"?"게시글이 없습니다.":"No posts available."})})]},f.id)})})]})]})},Qy=()=>{const{categoryId:i}=jf(),{language:h}=Pa(),u=Fa.find(r=>r.id===i);return u?T.jsxs("div",{className:"animate-fadeIn",children:[T.jsxs("header",{className:"mb-12 text-center",children:[T.jsx("h2",{className:"text-3xl md:text-4xl font-serif font-bold text-slate-900 mb-3",children:u.title[h]}),T.jsx("p",{className:"text-slate-500 font-light",children:u.description&&u.description[h]})]}),T.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-8",children:u.posts.map(r=>T.jsxs(zt,{to:r.isActive!==!1?`/${u.id}/${r.id}`:"#","aria-disabled":r.isActive===!1,onClick:c=>r.isActive===!1&&c.preventDefault(),className:`group rounded-xl overflow-hidden shadow-sm border border-slate-100 flex flex-col h-full
                        ...
                        `,children:[r.imageUrl&&T.jsxs("div",{className:"h-48 overflow-hidden relative",children:[T.jsx("img",{src:r.imageUrl,alt:r.title[h],className:`w-full h-full object-cover transform duration-700 ${r.isActive===!1?"grayscale":"group-hover:scale-110"}`}),T.jsx("div",{className:"absolute inset-0 bg-black/10 group-hover:bg-black/0 transition-colors"}),r.isActive===!1&&T.jsx("div",{className:"absolute inset-0 flex items-center justify-center bg-black/20",children:T.jsx(Dn,{className:"text-white/80",size:32})})]}),T.jsxs("div",{className:"p-6 flex flex-col flex-grow",children:[T.jsxs("div",{className:"mb-auto",children:[T.jsx("span",{className:"text-xs font-bold text-russia-blue uppercase tracking-wider mb-2 block",children:u.title[h]}),T.jsx("h3",{className:`text-xl font-serif font-bold mb-2 transition-colors ${r.isActive===!1?"text-slate-400":"text-slate-800 group-hover:text-russia-blue"}`,children:r.title[h]}),T.jsx("p",{className:"text-slate-500 text-sm line-clamp-2 leading-relaxed",children:r.subtitle&&r.subtitle[h]||(h==="ko"?"러시아에서의 기록...":"Records from Russia...")})]}),r.isActive!==!1&&T.jsx("div",{className:"mt-6 pt-4 border-t border-slate-100 flex justify-end items-center",children:T.jsxs("span",{className:"flex items-center text-xs font-semibold text-slate-600 group-hover:translate-x-1 transition-transform",children:[h==="ko"?"읽기":"Read"," ",T.jsx(Jr,{size:14})]})})]})]},r.id))})]}):T.jsx("div",{className:"text-center",children:h==="ko"?"카테고리를 찾을 수 없습니다.":"Category not found."})},Zy=()=>{const{categoryId:i,postId:h}=jf(),u=Wr(),{language:r}=Pa(),c=Fa.filter(q=>q.isActive).flatMap(q=>q.posts.filter(B=>B.isActive).map(B=>({...B,categoryId:q.id,categoryTitle:q.title}))),m=c.findIndex(q=>q.id===h),f=m>0?c[m-1]:null,S=m<c.length-1?c[m+1]:null,w=Fa.find(q=>q.id===i),p=w==null?void 0:w.posts.find(q=>q.id===h);if(!w||!p)return T.jsx("div",{className:"text-center",children:r==="ko"?"포스트를 찾을 수 없습니다.":"Post not found."});const M=w.isSinglePost?void 0:()=>u(`/${i}`),I=q=>({id:q.id,title:q.title[r],categoryId:q.categoryId}),D=f?I(f):null,U=S?I(S):null;return T.jsx(Wy,{post:p,categoryTitle:w.title,onBack:M,prevPost:D,nextPost:U})};function Jy(){const[i,h]=E.useState(!1),u=za(),r=Wr(),{language:c}=Pa();E.useEffect(()=>{h(!1),window.scrollTo(0,0)},[u.pathname]);const m=f=>{const S=Fa.find(w=>w.id===f);!S||S.isActive===!1||(S.isSinglePost&&S.posts.length>0?r(`/${S.id}/${S.posts[0].id}`):r(`/${S.id}`))};return T.jsxs("div",{className:"min-h-screen bg-[#f8fafc] text-slate-900 font-sans selection:bg-russia-blue selection:text-white",children:[T.jsx("div",{className:"bg-russia-dark text-white py-2 px-4 text-center text-xs font-bold tracking-[0.2em] uppercase",children:"JNP Presents"}),T.jsx("nav",{className:"sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-200",children:T.jsxs("div",{className:"container mx-auto px-4 md:px-6 h-16 flex items-center justify-between",children:[T.jsxs(zt,{to:"/",className:"font-serif font-bold text-xl md:text-2xl text-russia-blue cursor-pointer flex items-center gap-2",children:[T.jsx(by,{size:24}),T.jsx("span",{children:c==="ko"?"유라시아 견문록":"Eurasian Chronicles"})]}),T.jsx("div",{className:"hidden lg:flex items-center gap-6 text-sm font-medium text-slate-600",children:Fa.filter(f=>f.id!=="home").map(f=>T.jsxs(zt,{to:f.isActive===!1?"#":f.isSinglePost&&f.posts.length>0?`/${f.id}/${f.posts[0].id}`:`/${f.id}`,"aria-disabled":f.isActive===!1,onClick:S=>f.isActive===!1&&S.preventDefault(),className:`relative py-2 group transition-colors 
                  ${f.isActive===!1?"text-slate-300 cursor-not-allowed":"hover:text-russia-blue"}
                  ${u.pathname.startsWith(`/${f.id}`)?"text-russia-blue":""}
                `,children:[T.jsxs("div",{className:"flex items-center gap-1",children:[f.shortTitle&&f.shortTitle[c]||f.title[c],f.isActive===!1&&T.jsx(Dn,{size:10})]}),f.isActive!==!1&&T.jsx("span",{className:`absolute bottom-0 left-0 w-full h-0.5 bg-russia-blue transform scale-x-0 group-hover:scale-x-100 transition-transform ${u.pathname.startsWith(`/${f.id}`)?"scale-x-100":""}`})]},f.id))}),T.jsxs("div",{className:"flex items-center gap-2",children:[T.jsx(Vy,{}),T.jsx("button",{className:"lg:hidden p-2 text-slate-600",onClick:()=>h(!i),children:i?T.jsx(Lf,{}):T.jsx(Cy,{})})]})]})}),i&&T.jsx("div",{className:"lg:hidden fixed inset-0 z-40 bg-white pt-24 px-6 overflow-y-auto animate-fadeIn",children:T.jsxs("div",{className:"flex flex-col gap-6",children:[T.jsx(zt,{to:"/",className:"text-lg font-serif font-bold text-slate-800 text-left",children:c==="ko"?"홈으로":"Home"}),Fa.filter(f=>f.id!=="home").map(f=>T.jsxs(zt,{to:f.isActive===!1?"#":f.isSinglePost&&f.posts.length>0?`/${f.id}/${f.posts[0].id}`:`/${f.id}`,"aria-disabled":f.isActive===!1,onClick:S=>f.isActive===!1&&S.preventDefault(),className:`text-lg font-serif font-bold text-left flex items-center gap-2 
