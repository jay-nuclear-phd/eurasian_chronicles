...
export const year1Category: Category = {
  ...
  posts: [
    ...
    {
      id: 'side-1',
      title: '외전, 내가 느낀 러시아 (1) - 러시아의 산책',
      subtitle: '걷기 그 이상의 의미, 그리고 강인한 체력의 필요성',
      imageUrl: 'https://images.unsplash.com/photo-1547448415-e9f5b28e570d?q=80&w=1200&auto=format&fit=crop',
      isActive: true,
      comments: [],
      content: `
        <p class="leading-relaxed mb-6 text-slate-700 first-letter:text-5xl first-letter:font-bold first-letter:text-russia-blue first-letter:float-left first-letter:mr-3">
    ...
    },
    {
      ...
      imageUrl:
        'https://images.unsplash.com/photo-1580651315530-69c8e0026377?q=80&w=1200&auto=format&fit=crop', // Replaced with Korean Food (Bibimbap) image
      isActive: true,
      comments: [],
      content: `
           <p class="leading-relaxed mb-6 text-slate-700">
    ...
    {
      id: 'side-2',
      title: '외전, 내가 느낀 러시아 (2) - 러시아의 뇌물',
      subtitle: '공기처럼 자연스러운 유혹, 그리고 생존을 위한 선택',
      ...
      content: `
        ...
        <p class="leading-relaxed mb-6 text-slate-700">
          러시아인들은 보통 단 음식(특히 초콜릿)에 환장한다는 고급 정보를 입수한 우리는, 방 배정의 전권을 쥔 사감을 매수하기 위해 마트로 달려갔다. 🍫 꽤 그럴싸하고 고급스러운 초콜릿을 고른 뒤, 박스를 조심스럽게 뜯어 그 안에 아주 잘 보이도록 2천 루블(약 3~4만 원)짜리 지폐와 애교 섞인 작은 편지를 살포시 찔러 넣었다. 💌 
          <br/><br/>
