  ...
  posts: [
    {
      ...
      content: {
        ...
        en: `
          ...
          <p class="leading-relaxed mb-6 text-slate-700">
            With a soldier's spirit ingrained in me, I sat down with a grim determination to complete the <span class="font-bold text-russia-blue">mission(?)</span> of finishing my three-year master's program, including the preparatory faculty. However, tears welled up, perhaps because I thought about not being able to see my parents, siblings, and friends, or perhaps because of a vague fear of the unfamiliar land. 😭
          </p>
          ...
          <p class="leading-relaxed mb-6 text-slate-700">
            To enter a Russian university or graduate school, it is common to go through a preparatory faculty. So I went with the others who had come with me to register for the preparatory faculty. To register, we had to get our Russian documents notarized and submit Russian translations of our passport copies.
            <br/><br/>
    ...
    },
    {
      ...
      content: {
        ...
        en: `
          <p class="leading-relaxed mb-6 text-slate-700">
            I had already registered for the preparatory faculty once, so this time I helped my wife register for hers. The preparatory faculty assigned several dormitories, and when we revealed that we were a <strong>married couple 💑</strong> during the registration process, they assigned us to the same dormitory.
          </p>
          <p class="leading-relaxed mb-6 text-slate-700">
            It wasn't a family dormitory where a married couple could live in the same room, but we decided to stay there for the first year of the preparatory faculty because we heard it was cleaner and cheaper than the family dormitory. My wife was assigned a double room on a different floor from me, and fortunately, the roommate who was supposed to come didn't show up, so my wife got to use the spacious room by herself. 🍀 We were both busy with our studies, but visiting my wife's room was the best way to relax.
          </p>
    ...
    },
    {
      ...
      title: {
        ko: '예비학부에서의 공부',
        en: 'Studying at the Preparatory Faculty',
      },
      subtitle: {
      ...
      content: {
        ...
        en: `
           <p class="leading-relaxed mb-6 text-slate-700">
             The preparatory faculty of Moscow State University has long been more famous among international students by its nickname <strong>‘TsMO (ЦМО, Center for International Education)’</strong>. Although the official name was changed to <strong>'IRYaK (ИРЯиК, Institute of Russian Language and Culture)'</strong> in 2013, many people, including myself who first set foot in Russia in 2014, still called the preparatory faculty 'TsMO'. I assume it was because it was easy to pronounce and short.
           </p>
           ...
           <p class="leading-relaxed mb-6 text-slate-700">
             In Russian universities, instead of the 50-minute 'one-hour class' we are used to, there is a 1-hour 30-35 minute class unit called <strong>'para (пара)'</strong>. It usually includes a 5-10 minute break after a 45-minute class, so it was more manageable than I thought. The preparatory faculty had classes every day, and I took an average of four paras a day, which was a pretty tight schedule for a student.
           </p>

           <p class="leading-relaxed mb-6 text-slate-700">
             In 2014, the annual tuition was about $5,080. It was a 38-week course instead of the usual 32 weeks, with classes held every day and a class size of at most 6-7 students (my class had 4), so the educational density for the cost was not bad. However, since the purpose of the preparatory faculty is 'basic Russian language education for university admission,' it is difficult to expect an advanced level. The ultimate goal for most students is to pass the <strong>TORFL 1st level (ТРКИ-1)</strong>.
           </p>
           ...
           <p class="leading-relaxed mb-6 text-slate-700">
             The preparatory faculty also has some interesting anecdotes. Since most students are new to Russia, they often see the letters <strong>‘CCCP’</strong> all over Moscow and ask what it means in class. The teachers smile and explain that it is an abbreviation for the former Soviet Union. It looks like the English alphabet, but in Russian, C is read as ‘es’, and P as ‘er’, which is why this happens.
           </p>
    ...
    },
    {
      ...
      comments: [],
      content: {
        ko: `<p class="leading-relaxed mb-6 text-slate-700"> 그리운 고국 땅과는 직선거리로 약 <strong>6,600 km</strong>, 비행기로도 장장 14시간을 날아야 닿을 수 있는 모스크바에서, 문득문득 한국이 그리워지는 것은 어쩔 수 없다. 🇰🇷 하지만 대부분의 날이 흐리고 춥고, 사람들마저 쌀쌀맞은 이 낯선 도시 곳곳에서도 경험할 수 있는 한국의 조각들이 있다. </p> <h3 class="text-xl font-serif font-bold text-slate-800 mt-10 mb-4">🏛️ 모스크바의 작은 한국, 대사관</h3> <p class="leading-relaxed mb-6 text-slate-700"> 먼저 이야기 해 볼 것은 실제 법적으로는 한국 영토인 <strong>주러 한국대사관</strong>이다. 사실 유학생이 특별히 대사관을 방문할 일은 없지만 나는 몇 번 가볼 기회가 있었다. 모스크바에 도착한 그 해 12월 나는 대위로 진급이 예정되어 있었다. 진급하기 전 회식 자리에서 무관보좌관님은 진급식을 챙겨주신다며 아내 한복까지 준비 놓으라고 하셨다. 그 때까지 군기가 아직 덜 빠졌던 나는 그 말을 철썩같이 믿고 아내의 한복도 한국에서 보내서 준비를 마쳤다. </p> <p class="leading-relaxed mb-6 text-slate-700"> 내가 아내의 한복을 준비했다고 말씀드리니 반은 농담이었다고 하셨지만 그래도 무관님께 말씀드려서 대위 진급식을 대사관에서 할 수 있었다. 보통은 소령 진급식 정도는 되어야 가족도 초청해서 어깨에 새로운 견장도 달아주고 하는데 운이 좋게도 아주 먼 낯선 땅에서 영광스러운 진급식을 가질 수 있었다. ✨ </p> <div class="bg-slate-50 border-l-4 border-russia-blue p-6 rounded-r-lg my-6"> <p class="leading-relaxed text-slate-700"> "대사관 건물은 직사각형으로 생겼는데 가운데는 작은 직사각형의 빈 공간이 있었다. 거기에는 한국식으로 꾸며놓은 <strong>정자와 작은 연못</strong>이 있어 매우 인상적이었다. 대사관에서 근무하면 한국의 휴일과 현지 나라의 휴일을 모두 쉴 수 있다고 들었다는 말을 듣고 다음 생에는 꼭 대사관 직원이 되어야 겠다는 유쾌한 상상도 해보았다." </p> </div> <h3 class="text-xl font-serif font-bold text-slate-800 mt-10 mb-4">🥘 그리운 맛, 한국 식당</h3> <p class="leading-relaxed mb-6 text-slate-700"> 한국이 그리운 이유에는 음식을 빼놓을 수 없다. 모스크바에는 한국 식당이 여러 곳 있었다. 하지만 한국 식당이라고 해서 모두 우리가 아는 대한민국의 식당은 아니니 조심할 필요가 있다. 일례로 북한 사람이 운영하는 식당이 있고, 또 러시아에 몇 세대 전에 넘어온 고려인이 운영하는 식당도 있다. </p> <p class="leading-relaxed mb-6 text-slate-700"> 보통 한국 음식이 그리울 때면 <strong>인공위성</strong>이라는 이름의 호텔 내에 위치한 한국 식당을 찾았다. 이 호텔 내에는 여러 한국 식당이 있어서 선택지도 다양했고, 작은 한국식품점이 있어서 식사를 하고 한국 식재료를 사오기도 좋았다. </p> <p class="leading-relaxed mb-6 text-slate-700"> 그 외에도 다른 한국 식당들도 있었는데 그 중에 ‘자스민’이라는 이름의 식당에서는 메뉴에도 없는 보신탕을 알음알음 알고 찾아온 손님한테 팔기도 했다. 다른 식당에서는 토요일 점심에 600루블, 당시 한화로는 약 12,000원 정도에 한식 뷔페를 먹을 수 있었다. 김밥, 떡볶이와 같은 분식부터 불고기, 잡채 등 집에서 다 만들어 먹기는 번거로운 많은 음식이 있어서 자주 다녔다. 😋 </p> <h3 class="text-xl font-serif font-bold text-slate-800 mt-10 mb-4">🍜 고려인 식당과 북한 식당</h3> <p class="leading-relaxed mb-6 text-slate-700"> 그리고 한 번은 러시아 친구들과 <strong>고려인 식당</strong>에 가본 적도 있다. 대한민국의 음식과는 차이가 많이 났다. 메뉴판에는 조금 익숙한 발음의 음식이 있기도 했고 전혀 무슨 음식인지 유추할 수 조차 없는 음식도 많았다. 또한 한국 음식보다 식초를 많이 쓰는지 시큼한 맛이 나는 음식이 꽤나 있었다. 그래도 <strong>‘쿡시’</strong>라고 불리는 국수는 맛이 괜찮았다. 같이 갔던 러시아 친구들에게 이런 음식은 한국에서 결코 볼 수 없을 거라고 이야기했다. </p> <div class="bg-red-50 p-6 rounded-lg border border-red-200 my-6"> <h4 class="font-bold text-red-900 mb-2">🚫 평양스키 고려 (북한 식당)</h4> <p class="leading-relaxed text-red-800"> 우리가 자주 가던 ‘아샨’이라는 대형 마트에 가는 길에는 <strong>평양스키 고려</strong>라는 음식점이 있었다. 직역하자면 ‘평양의 고려’인데 이 곳은 북한 사람이 운영하는 진짜 북한 식당이었다. 감히 들어갈 볼 엄두는 못 내고 정문을 통해 지하로 내려가는 복도만 볼 수 있었는데 요정들과 신선들이 산과 호수를 배경으로 한 아주 특이한 그림들이 걸려 있었다. 현역 군인 신분이었던 나는 괜히 꺼려지는 마음에 러시아에 있는 동안 북한 식당을 가본 적이 없지만 지금 돌이켜보면 한 번쯤은 괜찮지 않았을까 하는 생각이 든다. </p> </div> <h3 class="text-xl font-serif font-bold text-slate-800 mt-10 mb-4">🎤 학생 생활과 조언</h3> <p class="leading-relaxed mb-6 text-slate-700"> 모스크바에 공부하러 온 학생들도 꽤나 많은데 한국식 노래방이 있어서 스트레스를 해소하러 간다고 했다. 모스크바 국립대 한인학생회는 여러 행사를 계획하는데 몇몇 행사에 참가해서 여러 학생들 각자가 느끼고 경험하는 모스크바에 대해서도 들을 수 있었다. </p> <hr class="border-slate-200 my-8 w-1/3 mx-auto" /> <p class="leading-relaxed mb-6 text-slate-700"> 해외에 살면 현지 적응과 향수 사이에서 적절한 밸런스를 잡아야 하지만 내 짧은 경험에서 비추어 보았을 때, 오히려 <strong>밸런스보다는 저공비행</strong>을 해야 한다고 말하고 싶다. ✈️ 한국이 그립다고 해서 한인 사회나 커뮤니티에만 매몰되는 것은 그리 바람직하지 않다. </p> <p class="leading-relaxed mb-6 text-slate-700"> 만약 정해진 기간을 두고 떠나온 유학길이라면, 한국은 딱 필요한 만큼만 찾고 최대한 낯선 곳에 익숙해지고 낯선 이들의 삶 속으로 깊숙이 파고드는 노력이 필요하다. 내가 만났던 한국 학생 일부는 학생회 활동에 지나치게 몰두한 나머지 학업을 뒷전으로 한 이들도 있었다. 믿고 외국에 보내준 부모님의 간섭이 없는 타국에서 밤 늦게까지 흥청망청 다니는 모습은 안타까울 따름이었다. </p>`,
        en: `<p class="leading-relaxed mb-6 text-slate-700"> In Moscow, approximately <strong>6,600 km</strong> in a straight line from my beloved homeland, a 14-hour flight away, it's inevitable to occasionally miss Korea. 🇰🇷 However, even in this unfamiliar city, where most days are cloudy and cold, and the people are even colder, there are fragments of Korea that can be experienced everywhere. </p> <h3 class="text-xl font-serif font-bold text-slate-800 mt-10 mb-4">🏛️ A Small Korea in Moscow, the Embassy</h3> <p class="leading-relaxed mb-6 text-slate-700"> First, let's talk about the <strong>Korean Embassy in Russia</strong>, which is legally Korean territory. In fact, international students don't usually have much reason to visit the embassy, but I had a few opportunities. In December of the year I arrived in Moscow, I was scheduled to be promoted to captain. At a dinner before the promotion, the Military Attaché's assistant told me to prepare my wife's hanbok for the promotion ceremony. At that time, I was still so ingrained in military discipline that I believed him implicitly and had my wife's hanbok sent from Korea and prepared. </p> <p class="leading-relaxed mb-6 text-slate-700"> When I told him I had prepared my wife's hanbok, he said it was half a joke, but he still spoke to the Military Attaché so that I could have my captain promotion ceremony at the embassy. Usually, you only invite family and get new shoulder epaulets for a major's promotion ceremony, but I was lucky enough to have a glorious promotion ceremony in a distant, unfamiliar land. ✨ </p> <div class="bg-slate-50 border-l-4 border-russia-blue p-6 rounded-r-lg my-6"> <p class="leading-relaxed text-slate-700"> "The embassy building was rectangular, and in the middle, there was a small, empty rectangular space. There was a <strong>pavilion and a small pond</strong> decorated in Korean style, which was very impressive. I heard that working at the embassy allows you to rest on both Korean holidays and local holidays, so I playfully imagined becoming an embassy staff member in my next life." </p> </div> <h3 class="text-xl font-serif font-bold text-slate-800 mt-10 mb-4">🥘 The Taste of Longing, Korean Restaurants</h3> <p class="leading-relaxed mb-6 text-slate-700"> Food is indispensable when talking about why I miss Korea. There were several Korean restaurants in Moscow. However, it's important to be careful, as not all Korean restaurants are the Korean restaurants we know from South Korea. For example, there are restaurants run by North Koreans, and also restaurants run by Koryo-saram (ethnic Koreans in the former Soviet Union) who moved to Russia several generations ago. </p> <p class="leading-relaxed mb-6 text-slate-700"> When I missed Korean food, I usually went to a Korean restaurant inside a hotel called <strong>'Sputnik' (Satellite)</strong>. This hotel had several Korean restaurants, offering a variety of choices, and there was also a small Korean grocery store, making it convenient to eat and buy Korean ingredients. </p> <p class="leading-relaxed mb-6 text-slate-700"> There were also other Korean restaurants, and among them, a restaurant named 'Jasmine' would secretly sell Boshintang (dog meat stew), which wasn't even on the menu, to customers who knew about it and came looking for it. At another restaurant, you could eat a Korean buffet for 600 rubles, about 12,000 won at the time, on Saturday lunch. It had many dishes, from snack foods like gimbap and tteokbokki to bulgogi and japchae, which were cumbersome to make at home, so I went there often. 😋 </p> <h3 class="text-xl font-serif font-bold text-slate-800 mt-10 mb-4">🍜 Koryo-saram Restaurants and North Korean Restaurants</h3> <p class="leading-relaxed mb-6 text-slate-700"> And once, I also went to a <strong>Koryo-saram restaurant</strong> with my Russian friends. The food was very different from Korean food. Some dishes on the menu had slightly familiar pronunciations, while others were completely unidentifiable. Also, it seemed that they used more vinegar than in Korean food, so there were quite a few sour dishes. Still, the noodles called <strong>'Kuksi'</strong> tasted good. I told my Russian friends that such food could never be seen in Korea. </p> <div class="bg-red-50 p-6 rounded-lg border border-red-200 my-6"> <h4 class="font-bold text-red-900 mb-2">🚫 Pyongyangski Koryo (North Korean Restaurant)</h4> <p class="leading-relaxed text-red-800"> On the way to 'Ashan', a large supermarket we often visited, there was a restaurant called <strong>Pyongyangski Koryo</strong>. Literally translated as 'Goryeo of Pyongyang', this was a real North Korean restaurant run by North Koreans. I didn't dare to go inside, but I could only see the corridor leading down to the basement through the main entrance. There were very unique paintings of fairies and immortals with mountains and lakes in the background. As an active military officer, I never went to a North Korean restaurant during my stay in Russia because I was worried about potential trouble, but looking back now, I wonder if it would have been okay to go just once. </p> </div> <h3 class="text-xl font-serif font-bold text-slate-800 mt-10 mb-4">🎤 Student Life and Advice</h3> <p class="leading-relaxed mb-6 text-slate-700"> Many students who came to Moscow to study said they went to Korean-style karaoke to relieve stress. The Korean student association of Moscow State University planned various events, and I participated in some of them and heard about Moscow from the perspective of various students. </p> <hr class="border-slate-200 my-8 w-1/3 mx-auto" /> <p class="leading-relaxed mb-6 text-slate-700"> Living abroad requires striking a balance between adapting to the local environment and homesickness, but based on my short experience, I want to say that it is better to <strong>fly low rather than balance</strong>. ✈️ It is not desirable to be buried only in the Korean community or society just because you miss Korea. </p> <p class="leading-relaxed mb-6 text-slate-700"> If you are studying abroad for a fixed period, you need to find Korea just enough, get used to the unfamiliar place as much as possible, and make an effort to delve deep into the lives of unfamiliar people. Some Korean students I met were so engrossed in student council activities that they neglected their studies. It was regrettable to see them out late at night, having fun, in a foreign country without the interference of their parents who believed in them and sent them abroad. </p>`,
      },
    },
    {
      id: 'post-106',
    ...
    {
      id: 'post-107',
      title: { ko: '예비학부 마무리, 그리고', en: 'Finishing the Preparatory Faculty, and...' },
      subtitle: {
      ...
      content: {
        ...
        en: `
          ...
          <p class="leading-relaxed mb-6 text-slate-700">
            The curriculum of the preparatory faculty itself includes many classes and a considerable amount of homework, so it strongly feels like they <span class="bg-yellow-100 px-1">drag students along by the scruff of their necks</span>. This is probably because the preparatory faculty is an institution operated with tuition fees from foreign students, so if the process is too difficult and dropouts occur, it directly impacts their finances by reducing the number of new students. There were no midterms each semester, only a final exam, and 70 points were enough to pass. 💯
          </p>
          ...
          <p class="leading-relaxed mb-6 text-slate-700">
            The preparatory faculty would conclude with this graduation exam, but I knew very well that the <strong>'main game'</strong> hadn't even started yet. The next step was to contact the department office of the university I was going to enter, get information about the entrance exam, and prepare for it. In my case, the preparatory faculty's graduation exam was in mid-May, and the main department's entrance exam was scheduled for around July, so I had about two months to prepare for the exam.
          </p>
          ...
          <p class="leading-relaxed mb-6 text-slate-700">
            The entrance exam was conducted differently from the exams taken at the preparatory faculty, in the way actual Russians take exams. The Russian exam has a unique system called <strong>"Bilet (Билет, English: Ticket)"</strong>. 🎫
          </p>
